		...
		<div class="container">
		   <div class="content">	 	 
				...
				<div class="col-md-9 cont span_2_of_3">
				  <div class="blog_grid">
		  	   	   <h2 class="post_title"><?=$details[0]['title'];?></h2>
		  	   	   <img src="<?=$details[0]['path'];?>" class="img-responsive" alt="" />
		  	   	   <p class="single"><?=$details[0]['content'];?></p>
		  	        <ul class="links">
						...
						<li><i class="views"> </i><span class="icon_text"><?=$details[0]['hits'];?> 浏览</span></li>
		  		    </ul>
					...
					<?php foreach($reply as $vreply):?>
		  		     <ul class="comment-list">
		  		    	<h5 class="post-author_head">回复 </h5>
		  		         ...
		  		         <span><?=$vreply['username'];?>&nbsp;:&nbsp;<?php echo date('Y-m-d H:i:s' ,$vreply['addtime']);?></span>
					...
					<div class="pagination pagination__posts">
		  		     ...
		  		     <div class="comments-area">
		  		        	<h3>发表回复</h3>
							<form method = "post" action = "index.php?m=single&a=addReply&id=<?=$_GET['id'];?>">
